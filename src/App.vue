...
/* ��亳仍亳 仗�亳 仆舒于亠亟亠仆亳亳 从���仂�舒 仆舒 checkbox */
.custom-checkbox:not(:disabled):not(:checked)+label:hover::before {
	border-color: #b3d7ff;
}

/* ��亳仍亳 亟仍� 舒从�亳于仆仂亞仂 �仂��仂�仆亳� �亠从弍仂从�舒 (仗�亳 仆舒亢舒�亳亳 仆舒 仆亠亞仂) */
.custom-checkbox:not(:disabled):active+label::before {
	background-color: #20741D;
	border-color: #80bdff;
}

/* ��亳仍亳 亟仍� �亠从弍仂从�舒, 仆舒�仂亟��亠亞仂�� 于 �仂从��亠 */
.custom-checkbox:focus+label::before {
	box-shadow: 0 0 0 0.2rem rgba(32, 116, 29, 0.10);
}

/* ��亳仍亳 亟仍� �亠从弍仂从�舒, 仆舒�仂亟��亠亞仂�� 于 �仂从��亠 亳 仆亠 仆舒�仂亟��亠亞仂�� 于 �仂��仂�仆亳亳 checked */
.custom-checkbox:focus:not(:checked)+label::before {
	border-color: #80bdff;
}

/* ��亳仍亳 亟仍� �亠从弍仂从�舒, 仆舒�仂亟��亠亞仂�� 于 �仂��仂�仆亳亳 disabled */
